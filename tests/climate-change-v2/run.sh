...
cucumber-js --require "../**/{cucumber-puppeteer,cucumber-puppeteer-axe}/features/**/*.js" --require "$TESTDIR/features/**/*.js" --world-parameters "{\"executablePath\":\"/usr/bin/chromium-browser\", \"slowMo\": 250, \"dumpio\": true, \"defaultViewport\": {\"width\": 1512, \"height\": 982}}" $TESTDIR/features --format=json:$TESTDIR/test-results.json --exit || true
cd $TESTDIR
node toHTML.js
node toJunit.js
