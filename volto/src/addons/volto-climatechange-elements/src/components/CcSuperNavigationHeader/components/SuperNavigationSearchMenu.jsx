    ...
    return (
        [
            ...
            >
                ...
                <span aria-hidden="true" className="gem-c-layout-super-navigation-header__navigation-top-toggle-close-icon" focusable="false">
                    ×
                </span>
            </button>,

            <div id="super-search-menu" className="gem-c-layout-super-navigation-header__search-items" hidden="hidden" key="super-search-menu">
                ...
                <div className="gem-c-layout-super-navigation-header__search-item">
                    <a className="gem-c-layout-super-navigation-header__search-item-link" href="/search" hidden="hidden">
